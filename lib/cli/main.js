...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ulitecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ulitecore-node add wallet-service');
      console.log('    $ ulitecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ulitecore-node remove wallet-service');
      console.log('    $ ulitecore-node remove insight-api');
      console.log();
    });
